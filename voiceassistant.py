...
def wishMe():
    ...
    speak("I am Ami Sir. Please tell me how may I help you")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('netaldevidan@gmail.com', '12345678')
    server.sendmail('netaldevidan@gmail.com', to, content)
    server.close()
...
def main():
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            say = "Hello, I am Ami. Your personal Assistant. I am here to make your life easier. You can command " \
            ...
            say = "I have been created by Netal"
            speak(say)
